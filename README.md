...
![DAResult](assets/da_res0.png)
![DAResult](assets/da_res1.png)

4. Merge ResNet layer4 (default layer) with layer3 to generate higher resolution feature maps.
...
## TODO
- [x] Add config to swith ResNet and ResNet+DA. See `lerobot/common/policies/act/configuration_act.py`
- [x] Add config to control DA input image size. See `lerobot/common/policies/act/configuration_act.py`
